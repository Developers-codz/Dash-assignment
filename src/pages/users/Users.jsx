            ...
            { searchedText.map((user, i) => {
              return (
                ...
                >
                  ...
                  />
                  <div className="sm:ml-4 sm:w-2/6  sm:place-items-start">{user.name}</div>
                  <div className="sm:w-2/6  sm:place-items-start">{user.email}</div>
                  <div className="hidden sm:block sm:w-1/6  sm:place-items-start">Male</div>
